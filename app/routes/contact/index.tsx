...
import { ClosedMailboxWithRaisedFlag } from '~/components/icons/Mailbox';
...
const ContactPage = ({ actionData }: Route.ComponentProps) => {
  return (
    <div className='max-w-3xl mx-auto mt-12 px-6 py-8 bg-gray-900'>
      <h2 className='flex justify-center items-center gap-3 text-3xl text-white font-bold mb-8'>
        <ClosedMailboxWithRaisedFlag /> Contact Me
      </h2>

      <form
        action='https://formspree.io/f/mnnzrgbd'
        method='post'
        className='space-y-6'
      >
        <div>
