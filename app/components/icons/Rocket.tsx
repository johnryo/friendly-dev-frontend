...
export function Rocket(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      ></path>
      <circle cx='8.999' cy='27' r='4' fill='#FFCC4D'></circle>
      <path
        fill='#55ACEE'
        d='M35.999 0s-10 0-22 10c-6 5-6 14-4 16s11 2 16-4c10-12 10-22 10-22'
      ></path>
      <path d='M26.999 5a4 4 0 0 0-3.641 2.36A4 4 0 0 1 24.999 7a4 4 0 0 1 4 4c0 .586-.133 1.139-.359 1.64A3.99 3.99 0 0 0 30.999 9a4 4 0 0 0-4-4'></path>
      <path
        fill='#A0041E'
